...
// 12-18-14 - Tyler Robbins - Constructor now takes second left and right Talons. Added new robotDrive instantiations. Replaced robot_drive with driveFront/Middle/Back.
...
// 	Joystick *joy)
Drive::Drive(Talon *left_1, Talon *left_2, Talon *left_3, 
	...
	// 			right_1,
	// 			right_3)
	driveFront(left_1,right_1),
	driveMiddle(left_2,right_2),
	driveBack(left_3,right_3)
	
	,m_def_command(new BackgroundDrive(this,joy))
	{

	// robot_drive.SetExpiration(0.5);
	driveFront.SetExpiration(0.5);
	driveMiddle.SetExpiration(0.5);
	driveBack.SetExpiration(0.5);
